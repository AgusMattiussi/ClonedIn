    ...
    <Form className='msform' onSubmit={handleSubmit}>
      ...
      <div className="d-flex mb-4">
        <label className="area">{t("Job Category")}</label>
          ...
          <option key={categoryListItem.id} value={categoryListItem.name}>{t(categoryListItem.name)}</option>
        ))}
        </Form.Select>
      </div>
      ...
      <Button variant="success" type="submit"><strong>{t("Register")}</strong></Button>
    </Form>
    <div className="row">
