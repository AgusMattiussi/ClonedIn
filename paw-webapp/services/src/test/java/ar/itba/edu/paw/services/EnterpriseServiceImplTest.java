...
public class EnterpriseServiceImplTest {
    ...
    public void testCreate() {
        Mockito.when(enterpriseDao.create(eq(TEST_EMAIL), eq(TEST_NAME), eq(TEST_PASSWORD), eq(TEST_LOCATION), eq(TEST_CATEGORY_NAME), eq(TEST_DESCRIPTION)))
                .thenReturn(new Enterprise(TEST_ID, TEST_NAME, TEST_EMAIL, TEST_PASSWORD, TEST_LOCATION, TEST_CATEGORY, TEST_DESCRIPTION, null));
    ...
    public void testFindByEmail() {
        Mockito.when(enterpriseDao.findByEmail(eq(TEST_EMAIL)))
                .thenReturn(Optional.of(new Enterprise(TEST_ID, TEST_NAME, TEST_EMAIL, TEST_PASSWORD, TEST_LOCATION, TEST_CATEGORY, TEST_DESCRIPTION, null)));
